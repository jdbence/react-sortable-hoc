...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SortableContainer2 = __webpack_require__(60);
	...
	var _SortableHandle2 = __webpack_require__(267);
	...
	var SortableGroup = function () {
	    function SortableGroup(onMove, getRefs) {
	        ...
	        this.startDragging = function (listName, index, delta, pageX, pageY) {
	            ...
	            var handle = (0, _utils.closestChild)(target, function (el) {
	        ...
	        this.debounceCheckList = (0, _lodash.debounce)(this.checkList, 250, { 'maxWait': 500 });
	        this.dragInfo = {
	            pageX: 0,
	            pageY: 0,
	            delta: { x: 0, y: 0 },
	    ...
	    (0, _createClass3.default)(SortableGroup, [{
	        ...
	        value: function closestList(x, y, lists) {
	            ...
	            (0, _lodash.each)(lists, function (c, key) {
